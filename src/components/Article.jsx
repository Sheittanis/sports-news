    ...
    return (
        <Segment vertical>
            <Container>
                ...
                <quote>Στη μεγάλη γιορτή του ΑΠΟΕΛ μας, στον Αρχάγγελο το Σάββατο 5 Οκτωβρίου, θα μας δωθεί η ευκαιρία να τιμήσουμε όπως του αξίζει, τον μεγάλο εμβληματικό αρχηγό Νούνο Μοράις. Πρόκειται για τον ποδοσφαιριστή με τα περισσότερα λεπτά συμμετοχής στην ιστορία του ΘΡΥΛΟΥ και αναμφισβήτητα έναν από τους πολυτιμότερους αθλητές της ομάδας μας από το 1926 μέχρι σήμερα. Ο μεγάλος κόσμος του ΑΠΟΕΛ θα δείξει την ημέρα εκείνη την αγάπη που τρέφει για τον μεγάλο μας αρχηγό.</quote>
            </Container>
        </Segment>
    )
}
